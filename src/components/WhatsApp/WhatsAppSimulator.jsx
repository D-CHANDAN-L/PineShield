    ...
    <div className="w-full flex flex-col space-y-3">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2.5 px-1 text-xs text-slate-400">
        <div className="flex items-center space-x-2">
          <span className="font-semibold text-slate-200">WhatsApp Web Simulator</span>
          <span className="text-[10px] font-mono px-2 py-0.5 rounded-full bg-emerald-950/70 text-emerald-400 border border-emerald-800 font-semibold">
            Dark Mode • Live Webhook Active
          </span>
        </div>
        ...
        <div className="flex flex-wrap items-center gap-2 text-[11px]">
          {onNavigateToSimulator && (
            <button
              ...
              className="px-2.5 py-1 rounded-lg bg-slate-800/80 hover:bg-slate-700 border border-slate-700/80 text-emerald-400 hover:text-emerald-300 font-medium transition flex items-center gap-1 cursor-pointer"
          ...
          <button
            ...
            className="px-2.5 py-1 rounded-lg bg-slate-800/80 hover:bg-slate-700 border border-slate-700/80 text-slate-300 hover:text-white flex items-center space-x-1.5 transition cursor-pointer"
          ...
          <button
            ...
            className="px-3 py-1 rounded-lg bg-[#00A884] hover:bg-[#008F6F] text-slate-950 font-bold flex items-center space-x-1 shadow-md transition cursor-pointer active:scale-95"
      ...
      {/* ========================================================================= */}
      <div className="w-full h-[660px] bg-[#111B21] border border-[#222E35] rounded-xl overflow-hidden shadow-2xl flex flex-col md:flex-row select-none">
        
        {/* ----------------------------------------------------------------------- */}
        {/* 2A. LEFT SIDEBAR (WhatsApp Web Chat List)                               */}
        {/* ----------------------------------------------------------------------- */}
        <div className={`${showMobileSidebar ? 'flex' : 'hidden'} md:flex md:w-[340px] lg:w-[380px] bg-[#111B21] border-r border-[#222E35] flex-col flex-shrink-0`}>
        ...
        {/* ----------------------------------------------------------------------- */}
        <div className={`${showMobileSidebar ? 'hidden' : 'flex'} flex-1 flex flex-col bg-[#0B141A]`}>
          
          {/* Native WhatsApp Header Bar (No custom pill buttons inside!) */}
          <div className="h-[59px] bg-[#202C33] px-3 sm:px-4 flex justify-between items-center border-b border-[#222E35] flex-shrink-0">
          ...
          {/* ------------------------------------------------------------------- */}
          <div className="min-h-[62px] bg-[#202C33] px-3 sm:px-4 py-2 flex items-center gap-2 sm:gap-3 border-t border-[#222E35] flex-shrink-0">
            {/* Emoji Picker Icon */}
            <button
              type="button"
